  ...
  regions: [
    {
      ...
      address: [
        "Astana, Mangilik El Ave, C1",
        "г. Астана, пр. Мангилик Ел, С1",
        "Астана қ., Мәңгілік Ел даңғ., С1",
      ],
    ...
    },
    {
      ...
      title: ["Farabi Hub", "Farabi Hub", "Farabi Hub"],
      address: [
    ...
    },
    {
      ...
      address: [
        "Shymkent, Zeyin Business Center, Severnaya District, 66/2",
        "г. Шымкент, БЦ Зейин, мкр. Северный, 66/2",
        "Шымкент қ., Зейін БО, Солтүстік ш/а, 66/2",
      ],
    ...
    },
    {
      ...
      title: [
        "Terricon Valley (Karaganda)",
        "Terricon Valley (Караганда)",
        "Terricon Valley (Қарағанды)",
      ],
      address: [
        "Karaganda, Alalykyna St., 12/1",
        "г. Караганда, ул. Алалыкина, 12/1",
        "Қарағанды қ., Алалыкин к-сі, 12/1",
      ],
    ...
    },
    {
      ...
      title: [
        "Zhubanov University (Aqtobe)",
        "Университет Жубанова (Актобе)",
        "Жұбанов атындағы Университет (Ақтөбе)",
      ],
      address: [
        "Aktobe, Aliya Moldagulova Avenue, 34",
        "г. Актобе, пр. Алии Молдагуловой, 34",
        "Ақтөбе қ., Әлия Молдағұлова даңғ., 34",
      ],
    ...
    },
    {
      ...
      title: [
        "Toraighyrov University (Pavlodar)",
        "Toraighyrov University (Павлодар)",
        "Торайғыров Университеті (Павлодар)",
      ],
      address: [
        "Pavlodar, Pavlodar, Lomov Street 64",
    ...
    },
    {
      ...
      address: [
        "Oskemen (Ust-Kamenogorsk), Kazakhstan Street 59/1",
        "г. Усть-Каменогорск, ул. Казахстан, 59/1",
        "Өскемен қ., Қазақстан к-сі, 59/1",
      ],
    ...
    },
    {
      ...
      address: [
        "Kostanay, Abay Avenue. 28/1",
        "г. Костанай, пр. Абая, 28/1",
        "Қостанай қ., Абай даңғ., 28/1",
      ],
    ...
    },
    {
      ...
      title: ["Atyrau Hub", "Atyrau Hub", "Atyrau Hub"],
      address: [
        "Kenzhebay Madenov Street, 7A",
        "Улица Кенжебай Маденов, 7а",
        "Кенжебай Маденов көшесі, 7а",
      ],
      link: "https://go.2gis.com/QAo3z",
    },
    {
      id: "abai",
      ...
      title: ["Abay IT-Valley", "Abay IT-Valley", "Abay IT-Valley"],
      address: ["Abay Street, 107", "Улица Абая, 107", "Абай көшесі, 107"],
      link: "https://go.2gis.com/NIoVR",
    },
    {
      id: "zhetisu",
      ...
      title: [
        ...
        "Jetisu Digital (Талдыкорган)",
        "Jetisu Digital (Талдықорған)",
      ],
      address: [
        "Taldykorgan, Kunayev St., 47",
        "г. Талдыкорган, ул. Кунаева, 47",
        "Талдықорған қ., Қонаев к-сі, 47",
      ],
    ...
    },
    {
      ...
      address: [
        "Kyzylorda, Aiteke Bi St., 29A",
        "г. Кызылорда, ул. Айтеке Би, 29А",
        "Қызылорда қ., Әйтеке Би к-сі, 29А",
      ],
    ...
    },
    {
      ...
      title: ["Batys Hub", "Batys Hub", "Batys Hub"],
      address: [
    ...
    },
    {
      ...
      address: [
        "Petropavl, Zhambyl Zhabayev St., Bldg. 19",
        "г. Петропавловск, ул. Жамбыла Жабаева, 19",
        "Петропавл қ., Жамбыл Жабаев к-сі, 19 үй",
      ],
      link: "https://go.2gis.com/6P92W",
    },
    {
      id: "turkistan",
      ...
      address: [
        "Turkistan, Bekzat Sattarkhanov Ave, 36, 2nd floor",
        "г. Туркестан, пр. Бекзат Саттарханова, 36, 2 этаж",
        "Түркістан қ., Бекзат Саттарханов даңғ., 36, 2-қабат",
      ],
      link: "https://go.2gis.com/vPFRY",
    },
    {
      id: "kokshetau",
      ...
      title: ["Aqmola Hub", "Aqmola Hub", "Aqmola Hub"],
      address: ["Yuri Gagarin Street, 7", "Улица Юрия Гагарина, 7", "Юрий Гагарин көшесі, 7"],
      link: "https://go.2gis.com/SZ0nt",
    },
    {
      id: "aktau",
      ...
      title: ["Mangystau Hub", "Mangystau Hub", "Mangystau Hub"],
      address: ["6th microdistrict, 50", "6-й микрорайон, 50", "6-ықшам аудан, 50"],
      link: "https://go.2gis.com/FR2Xg",
    },
    {
      id: "konaev",
      ...
      address: [
        "Konaev, Kunayev Ave, 5B",
        "г. Конаев, пр. Кунаева, 5Б",
        "Қонаев қ., Қонаев даңғ., 5Б",
      ],
  ...
  faq: [
    ...
    },
    {
      question: [
        ...
        "Могу ли я участвовать, если мне *меньше 18 лет*?",
        "Егер мен *18 жасқа толмаған* болсам, қатыса аламын ба?",
      ],
      answer: [
        "Yes, you can participate. However, your team captain must be *at least 18 years old*. This requirement allows us to properly process the necessary documents in case your team wins.",
        "Да, можете. Однако капитан вашей команды должен быть *старше 18 лет*. Это необходимо для корректного оформления документов в случае победы.",
        "Иә, қатыса аласыз. Бірақ команда капитаны *18 жастан асқан* болуы керек. Бұл жеңіске жеткен жағдайда қажетті құжаттарды дұрыс рәсімдеу үшін қажет.",
      ],
    },
    {
      question: [
