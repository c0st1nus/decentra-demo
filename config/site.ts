...
export const siteConfig = {
  ...
  highlightsSection: {
    ...
    subtitle: ["Decentrathon 5.0", "Decentrathon 5.0", "Decentrathon 5.0"],
  },
  highlights: [
    {
  ...
  partners: [
    ...
    {
      name: ["Ministry of Digital Development & AI", "МЦРИАП РК", "ҚР ЦДИАӨМ"],
    },
    {
